...
public class EmployeeServiceTests {
	...
	@Test //test0
	public void testWhenEmployeeCreated_thenThatEmployeeIsSaved() {
		// given
		...
		Employee newEmployee = employeeService.getEmployee(1);

		// then
		assertNotNull(newEmployee);
		assertNotNull(newEmployee.getEmpId());
		assertEquals("Alex", newEmployee.getEmployeeName());
	}
